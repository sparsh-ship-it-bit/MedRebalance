    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-lg">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Register Your Hospital</h1>
          <p className="text-sm text-slate-500 mt-1">Join the MedRebalance network</p>
        </div>
