...
export default function OnboardingBanner() {
  ...
  return (
    <div className="bg-[#eef8f6] border border-[#c5e6df] rounded-2xl p-5 mb-6 shadow-sm">
      <div className="flex items-start gap-4">
        <div className="flex-shrink-0">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#0f766e] text-white shadow-sm">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
            <div className="flex items-start gap-2">
              <Activity className="w-4 h-4 text-[#0f766e] mt-0.5 flex-shrink-0" />
            ...
            <div className="flex items-start gap-2">
              <Zap className="w-4 h-4 text-[#0f766e] mt-0.5 flex-shrink-0" />
              <p className="text-slate-600">
